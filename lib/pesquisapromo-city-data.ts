...
export const shops: Shop[] = [
  ...
  },
  {
    ...
    streetSlug: "testes",
    kind: "daily-deal",
    summary: "Uma oferta central com leitura rápida e sinais de confiança, validada no ambiente piloto.",
  ...
  },
  {
    ...
    streetSlug: "testes",
    kind: "general",
    summary: "Sandbox oficial para validar experiência de busca e vitrine.",
...
export const cityDestinations: CityDestination[] = [
  ...
  ...offers.slice(0, 4).map((offer) => ({
    ...
    summary: offer.verifiedDiscount
      ...
      : "Oferta verificada pela plataforma.",
