    ...
    shops: [
      {
        ...
        street: "Rua da Casa",
        vibe: "Comparacao mais serena, inspirada em lojas reais de Horizonte como J Erivaldo & Cia e Zenir Moveis.",
    ...
    shops: [
      {
        ...
        vibe: "Porta de entrada para Prefeitura, Ouvidoria, E-SIC e servicos municipais de Horizonte.",
        badge: "oficial",
      ...
      },
      {
        ...
        street: "Rua dos Servicos",
        vibe: "Loja real de papelaria em Horizonte, boa para testar comecio local com fonte publica verificavel.",
        badge: "mais verificavel",
